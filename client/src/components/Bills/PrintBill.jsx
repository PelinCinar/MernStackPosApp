...
const PrintBill = ({ isModalOpen, setIsModalOpen, customer }) => {
  // const componentRef = useRef(); //dom içerisindeki bir ellemntin içerisinde current değeindeki value değerlerine erişebiliyruz ref için yazıyorum
  ...
  return (
    <Modal 
      ...
      width={800}
    >
      <section className="py-20 bg-[#8b7355]" ref={componentRef}>
        <div className="max-w-5xl mx-auto bg-white px-6">
          <article className="overflow-hidden">
            <div className="logo my-6">
              <h2 className="text-4xl font-thin text-slate-700 bg-slate-100 inline-block px-2 py-1 rounded-lg">
                TARSUSİ
              </h2>
            </div>
                ...
                <tfoot>
                  <tr>
                    ...
                    <th
                      ...
                      colSpan="4"
                    >
                      <p className="font-normal text-slate-700"> </p>
                    </th>
                    <th
                      className="text-right pt-4 sm:table-cell hidden"
                      colSpan="4"
                  ...
                  <tr>
                    <th
                      ...
                      scope="row"
                    >
                      <span className="font-normal text-slate-700 text-lg">
                        Genel Toplam
                      </span>
                    </th>
                    <th
              ...
              <div className="py-9">
                <div className="border-t pt-9 border-slate-200">
                  <p className="text-sm font-light text-slate-700">
                    ...
                    Ödenmesi Yasası e göre, serbest çalışanların bu süreden
...
PrintBill.propTypes = {
  ...
  customer: PropTypes.object.isRequired, // Eğer bir nesne ise
};
